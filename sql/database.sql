...
CREATE POLICY "Allow authenticated SCUML review" ON public.scuml_applications FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Allow authenticated SCUML status updates" ON public.scuml_applications;
CREATE POLICY "Allow authenticated SCUML status updates" ON public.scuml_applications FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow authenticated NIN review" ON public.nin_applications FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Allow authenticated NIN status updates" ON public.nin_applications;
CREATE POLICY "Allow authenticated NIN status updates" ON public.nin_applications FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow authenticated NIN name-change review" ON public.nin_name_changes FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Allow authenticated NIN name-change status updates" ON public.nin_name_changes;
CREATE POLICY "Allow authenticated NIN name-change status updates" ON public.nin_name_changes FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow authenticated NIN date-change review" ON public.nin_date_changes FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "Allow authenticated NIN date-change status updates" ON public.nin_date_changes;
CREATE POLICY "Allow authenticated NIN date-change status updates" ON public.nin_date_changes FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
